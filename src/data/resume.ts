...
export const orbitSkills: OrbitSkill[] = [
  ...
  { label: "EC2", url: "https://docs.aws.amazon.com/ec2/" },
    { label: "S3", url: "https://docs.aws.amazon.com/s3/" },
    { label: "Lambda", url: "https://docs.aws.amazon.com/lambda/" },
    { label: "CloudTrail", url: "https://docs.aws.amazon.com/cloudtrail/" },
    { label: "IAM", url: "https://docs.aws.amazon.com/iam/" },
    { label: "SageMaker", url: "https://docs.aws.amazon.com/sagemaker/" },
    { label: "Bedrock", url: "https://docs.aws.amazon.com/bedrock/" },
    { label: "Comprehend", url: "https://docs.aws.amazon.com/comprehend/" },
    { label: "Rekognition", url: "https://docs.aws.amazon.com/rekognition/" },
    { label: "Polly", url: "https://docs.aws.amazon.com/polly/" },
    { label: "Q", url: "https://docs.aws.amazon.com/q/" },
    { label: "A2I", url: "https://docs.aws.amazon.com/a2i/" },
    { label: "Macie", url: "https://docs.aws.amazon.com/macie/" },
];
